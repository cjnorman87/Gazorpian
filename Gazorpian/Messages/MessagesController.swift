...
//  Gazorpian
//
//  Created by Christopher Norman on 10/11/17.
...
//        let image = UIImage(named: "new_message_icon")
    ...
    @objc func handleReloadTable() {
        ...
        self.messages.sort { (mess1, mess2) -> Bool in
            return Int32(truncating: mess1.timestamp!) > Int32(truncating: mess2.timestamp!)
        }
